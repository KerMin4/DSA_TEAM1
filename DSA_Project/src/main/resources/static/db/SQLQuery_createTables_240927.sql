 ...
 * MySQL, DBeaver
 * Correct misspelling
 * Add Constraint name: FK_referencedTable2referencingTable_referencingFieldName // CK_conditionContents
 * Add Table Bookmark
 * Delete Table Trend
...
CREATE TABLE Bookmark (
    ...
    constraint CK_NOTNULL_place_id_OR_group_id CHECK (place_id IS NOT NULL OR group_id IS NOT NULL)
);
